...
Shader::Shader(const std::string& fileName) {
    ...
    CheckShaderError(m_program, GL_LINK_STATUS, GL_TRUE, "Error: Program linking failed: ");
...
static GLuint CreateShader(const std::string& text, GLenum shaderType) {
    ...
    shaderSourceStringsLengths[0] = (GLint)text.length();
